            ...
            <Card className="main-card">
              <Card.Body className="p-lg-4 p-3">
                ...
                <Row className="g-3 g-lg-4 h-100">
                  ...
                  <Col xs={12} lg={8} xl={7} className="order-1 order-lg-1 d-flex">
                    <Card className="h-100 circle-card flex-fill">
                  ...
                  <Col xs={12} lg={4} xl={5} className="order-2 order-lg-2 d-flex">
                    <div className="scale-info-panel flex-fill">
                      {/* Quick Key Selection */}
                      <Card className="mb-4">
                        <Card.Header>
                          <h6>Quick Select</h6>
